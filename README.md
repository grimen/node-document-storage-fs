# NODE-DOCUMENT-STORAGE-FS [![Build Status](https://secure.travis-ci.org/grimen/node-document-storage-fs.png)](http://travis-ci.org/grimen/node-document-storage-fs)

**Storage** adapter [fs](http://nodejs.org/api/fs.html) for [node-document](https://github.com/grimen/node-document) ODM for Node.js.


## Installation

```shell
  $ npm install node-document-storage-fs
```
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/grimen/node-document-storage-fs/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
